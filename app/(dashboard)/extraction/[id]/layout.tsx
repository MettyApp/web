...
export default function ExtractionLayout({
  ...
  return (
    <div className='bg-white/95 flex flex-1 min-w-0'>
      <div className='hidden lg:block overflow-scroll p-5 w-80'>
        <Suspense fallback={<PingLoader />}>
          <ExtractionList />
        </Suspense>
      </div>
      <div className='bg-white flex-1'>
        <div className='flex xl:flex-row flex-col p-4 min-w-0 md:overflow-scroll xl:overflow-hidden h-full'>
